...
# (project=scitex-events, owner=ywatanabe1989, repo=scitex-events,
...
TMPDIR="/tmp/publish-scitex_events-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-events dist/* uploaded to PyPI via manual OIDC trusted publishing"
